...
that means, It's the pure calculation phase that doesn't directly interact with the DOM
...
**Interruptibility**:- In React the render phase can be paused, interrupted or even restarted to prioritize more urgent updates.
